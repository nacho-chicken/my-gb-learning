...
Saving is a must for most games. Who wants to bother with passwords when
SRAM (or rather, modern storage) is so cheap? This is just a very simple
saving/loading system. Loading happens automatically on game start.
You can save by pressing start at any time. Only the player's position
is saved.
*/
