...
I wanted to do this last time, but it wouldn't have been the same without
at least the illusion of randomness. I'm going to be adding 39 NPCs.
This should stress test the limits of the GBC at least a little bit.
...
NPCInit:
	ld	hl, OAM_RAM + SPRITE_DATA_SIZE
	; 40 is the total number of sprites the GBC can have at one time
	; The player is one, but this will loop over the remaining 39
	ld	d, 0 ; Current sprite
.loop:
	push	de
	push	hl
	ld	bc, wScratch
