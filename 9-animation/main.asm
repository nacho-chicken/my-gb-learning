...
Now that I know how to draw a ton of sprites, it's time to animate them.
There are still going to be 40 sprites total, but each will start on a
different frame of animation to make them look like different objects.
I'll be using a 16x16 image from an old project. Each object should take
4 sprites to make up, meaning there should be enough space for 9 objects.
